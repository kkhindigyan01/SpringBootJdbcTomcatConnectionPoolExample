...
public class SpringBootJdbcTomcatConnectionPoolExampleApplication {

	public static void main(String[] args) {
		ConfigurableApplicationContext applicationContext = SpringApplication.run(SpringBootJdbcTomcatConnectionPoolExampleApplication.class, args);
